    ...
    <app-layout title="Event">
        ...
        <div class="py-12">
            <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
                <section class="my-4">
                    <secondary-button @click="openPanel('create')" >Aggiungi una nuova iniziativa</secondary-button>
                </section>
                ...
                <slide-over :panelStatus="panelStatus" @statusPanel="closePanel()">
                    ...
                    <template v-slot:content>
                        <div class="p-4 border rounded-md border-gray-200" v-if="!isModify">
                            ...
                            <input class="border-gray-300 focus:border-green-miac focus:ring focus:ring-indigo-200 focus:ring-opacity-50 rounded-md shadow-sm" type="text" id="name" name="name" v-model="event.name"><br><br>
...
export default defineComponent({
    ...
    methods: {
        openPanel(status){
            this.provice = null
            if(status==="modify"){
                this.titlePanel = 'Modifica i dati della iniziativa';
                this.isModify = true
            }else{
                this.titlePanel = 'Aggiungi una nuova iniziativa';
                this.isModify = false
            }
